...
if __name__ == '__main__':
    ...
    for imageName in jpg_files:
        ...
        plt.imsave(outDir + imageName[:-4] + '_sobel_edges.jpg', finalImage)
    ...
    for imageName in tif_images:
        ...
        # Writing the image to the Results folder
        plt.imsave(outDir + imageName[:-4] + '_test.tiff', finalImage) #saving in tiff file as matplotlib save doesn't support tifs
